    ...
    <section id="about" className="py-16 bg-gradient-to-b from-gray-900 to-gray-800">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold text-amber-400 mb-6" data-aos="fade-up">About Since Gulf Bazar</h2>
          <p className="text-gray-300 text-lg leading-relaxed mb-6" data-aos="fade-up" data-aos-delay="100">
